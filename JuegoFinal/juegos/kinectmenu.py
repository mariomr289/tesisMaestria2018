...
class IdleScreen():
	def __init__(self, screen):
		...
		self.menuFuncs = { 	"Nuevo Juego" : self.startNewGame,
							"Salir" : self.salir,
							"Hola" : self.hola,
							"Chao" : self.chao}
		self.animalImgs = []
	...
	def run(self):
		...
		while screenloop:
			...
			self.menuItems[self.secondActiveFocus].removeFocus()
			self.menuItems[self.thirdActiveFocus].removeFocus()
